...
@Component
@Data
public class OracleConsulServerService extends ConsulServerService implements OracleDistributedService<ConsulApi> {
  @Delegate
  @Autowired
  ...
  public List<String> getScopes() {
    List<String> scopes = OracleDistributedService.super.getScopes();
