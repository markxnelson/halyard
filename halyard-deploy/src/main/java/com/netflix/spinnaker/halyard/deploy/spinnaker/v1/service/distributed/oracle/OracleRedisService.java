...
@Data
@Component
public class OracleRedisService extends RedisService implements OracleDistributedService<Jedis> {
  ...
  @Override
  public Jedis connectToPrimaryService(AccountDeploymentDetails<OracleAccount> details, SpinnakerRuntimeSettings runtimeSettings) {
